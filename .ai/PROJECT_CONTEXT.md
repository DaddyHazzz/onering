...
1. **Dev setup:** See [ARCHITECTURE.md](ARCHITECTURE.md)
2. **Running tests:** See [TESTING.md](TESTING.md)
3. **What to work on:** See [ROADMAP.md](ROADMAP.md)
4. **Understanding design:** See [DECISIONS.md](DECISIONS.md)

## Contact

- **Questions about vision?** → See [ROADMAP.md](ROADMAP.md)
- **Questions about code?** → See [ARCHITECTURE.md](ARCHITECTURE.md)
- **Questions about decisions?** → See [DECISIONS.md](DECISIONS.md)
